...
void a_rendComp(){
    ...
    scene->add(new FracLand(Point(800.f, 0.f, 1000.f), Point(-800.f, 0.f, 1000.f), Point(0.f, 0.f, 0.f), 2, 1.f, nullptr, mirror));
//    scene->add(new InfinitePlane(Point(0.0f,0.0f,-0.018f), Vector(0.f, 1.f, 0.f), nullptr, mirror));
